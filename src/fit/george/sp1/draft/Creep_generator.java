...
public class Creep_generator extends Sprite {
	...
	private void makeCreeps() {
		...
		if ( actual_wave == 0 ) {
			...
			count = 15;
			creeps[0] = new CreepLevel1(130, 0, 48, 64, MainActivity.instance.creepLevel1Texture, MainActivity.instance.getVertexBufferObjectManager(), 100, 10);
			creeps_alive.add( creeps[0] );
		}
		else if ( actual_wave == 1 ) {
			creeps = new SimpleCreep[7];
			count = 7;
			creeps[0] = new CreepLevel2(130, 0, 48, 64, MainActivity.instance.creepLevel2Texture, MainActivity.instance.getVertexBufferObjectManager(), 150, 13);
			creeps_alive.add( creeps[0] );
		}
		else if ( actual_wave == 2 ) {
			creeps = new SimpleCreep[5];
			count = 5;
			creeps[0] = new Creep_octopus(120, 0, 60, 60 , MainActivity.instance.octopus, MainActivity.instance.getVertexBufferObjectManager(), 300, 25);
			creeps_alive.add( creeps[0] );
		}
		else {
			count = 12;
		...
		game_Scene.game_instance.registerUpdateHandler(new TimerHandler(1.3f, true, new ITimerCallback() {
			...
			public void onTimePassed(final TimerHandler pTimerHandler) {				
				...
				if( a < Creep_generator.count )  {
					...
					if ( actual_wave == 0 ) creeps[a] = new CreepLevel1(130, 0, 48, 64, MainActivity.instance.creepLevel1Texture, MainActivity.instance.getVertexBufferObjectManager(), 150, 10);
					else if ( actual_wave == 1 ) creeps[a] = new CreepLevel2(130, 0, 48, 64, MainActivity.instance.creepLevel2Texture, MainActivity.instance.getVertexBufferObjectManager(), 300, 25);
					else if ( actual_wave == 2 ) creeps[a] = new Creep_octopus(120, 0, 60, 60 , MainActivity.instance.octopus, MainActivity.instance.getVertexBufferObjectManager(), 300, 25);
					else {
						if ( a%3 == 0 ) creeps[a] = new CreepLevel1(130, 0, 48, 64, MainActivity.instance.creepLevel1Texture, MainActivity.instance.getVertexBufferObjectManager(), 300, 25);
						else if ( a%3 == 1 ) creeps[a] = new CreepLevel2(130, 0, 48, 64, MainActivity.instance.creepLevel2Texture, MainActivity.instance.getVertexBufferObjectManager(), 300, 25);
						else if ( a%3 == 2 ) creeps[a] = new Creep_octopus(120, 0, 60, 60 , MainActivity.instance.octopus, MainActivity.instance.getVertexBufferObjectManager(), 300, 25);
					}
